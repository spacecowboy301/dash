...
- Enforce a hard $5 monthly OpenAI budget with per-workflow usage tracking.
- Reserve estimated cost before every model call and stop new calls before the safety buffer.
